...
/**
 * PluggableSchemaResolver 用来解析 xsd 声明文件
 *
		...
		if (schemaMappings == null) {
			synchronized (this) {
				...
				if (schemaMappings == null) {
					...
					try {
						// 从schemaMappingsLocation中加载所有的属性(META-INF/spring.schemas)
						Properties mappings =
